...
const DOMAIN_NAV: Record<string, NavItem[]> = {
  "ip-core": [
    ...
    { label: "Knowledge Graph", href: "/network-model/ip-core", icon: Network },
    { label: "Reports",       href: "/flm-reports",          icon: BarChart2 },
    { label: "Assistant",     href: "/assistant",            icon: MessageSquare },
  ],
  "cxi": [
    { label: "Dashboard",     href: "/dashboard",            icon: LayoutDashboard },
    { label: "Knowledge Graph", href: "/network-model/cxi",    icon: Network },
  ...
  "volte": [
    ...
    { label: "Knowledge Graph", href: "/volte/network-model",  icon: Network },
...
const SCENARIO_NAV: Record<string, NavItem[]> = {
  ...
  s3: [
    { label: "Dashboard",     href: "/dashboard",            icon: LayoutDashboard },
    { label: "Knowledge Graph", href: "/network-model/volte",  icon: Network },
    { label: "Agent activity",href: "/agents",               icon: Bot },
    { label: "Reports",       href: "/reports",              icon: BarChart2 },
    { label: "Assistant",     href: "/assistant",            icon: MessageSquare },
  ],
